...
*导入数据
cd "D:\PhD PSU\Dissertation\Stata project"
import excel "D:\PhD PSU\Dissertation\Python project\data\igt.xlsx", firstrow clear

*************数据整理和清洗*********************
*删除缺失值
sum lgigt c p population lgpl wapw mhi ur lggdp lgml if missing(lgigt, c, p, population, lgpl, wapw, mhi, ur, lggdp, lgml) == 0
summarize lgigt c p population lgpl wapw mhi ur lggdp lgml
...
*esttab m1 m2 m3 using res.rtf,ar2 label
